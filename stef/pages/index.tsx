  ...
  let allPages: any = [
    {
      ...
      second: (
        <>
          ...
          <p className={styles.desc}>
            Has viajaste veinteseis viajes al redador del sol. Con tu corazon
            encendido de pasion{" "}
            <span
              style={{
            ...
            . Yo se que tus sueños realizaran.
          </p>
          <p className={styles.desc}>
            Eres una planta quien extiende sus raices lejos y anchos para
            aferrarse a la verdad. Es increible.
          </p>
        </>
      ),
    },
      ...
      first: (
        <>
          ...
          <p className={styles.desc}>
            ...
            <span
              style={{
                transform: `translateX(${-backgroundMover * 0.005 + 0.05}rem)`,
              }}
            >
              🕺
            </span>
            ...
            mientras nos miramos en los ojos algun dia. Te dare tus besitos de
            cumpleaños. Agradezco concerte, y espero que podamos crecer juntos.
            Eso es real.
            <span>😉</span>
          </p>
          <p>&nbsp;</p>
